...
function App() {
  ...
  return (
    <div
      ...
      } min-h-screen flex justify-center  roboto-medium  transition-colors ease-in-out duration-300`}
    >
      <div className="flex flex-col gap-2 mt-6 md:mt-10 p-2">
        <div className="w-full flex flex-row justify-center gap-2">
          <form
            className=" flex flex-row gap-1
             md:gap-2 border-[1px] bg-white rounded-md "
            id="search-form"
          >
            <input
              type="text"
